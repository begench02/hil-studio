	...
	return (
		<div className={styles.main}>
			...
			<div className={styles.team2}>
				Together with the strongest team in Ashgabat, we have solved and helped companies in Ashgabat to fight
				their design and tech problems. you're happy we won
