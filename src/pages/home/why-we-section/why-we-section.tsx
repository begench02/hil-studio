...
import fastResults from 'assets/images/fast-results.jpg'
		...
		<section>
			<div className={styles.a}>
				<h1 className={styles.heading}>
					Why <span style={{ color: '#FF9882' }}>Hil</span> Studio
			...
			<div>
				<Link heading='Fast Results' subheading='Learn what we do here' imgSrc={fastResults} href='#' />
				...
				<Link heading='Free Consulting' subheading='We want cool people' href='#' imgSrc={freeConsulting} />
			</div>
		</section>
	)
}
